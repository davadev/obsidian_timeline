...
| `shortEventLabels` | boolean | `true` | Name point events and spans too narrow to hold a label, beside the bar with a leader pointing at it. Only events fully in view are named. `false` leaves them unnamed until you zoom in. |
